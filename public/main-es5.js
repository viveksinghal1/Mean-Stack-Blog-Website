      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          function SidebarCollapse() {
            ...
            $('#sidebar-container').css('transition', '0.2s'); // Treating d-flex/d-none on separators with title
